...
extern Struct_CAN User_CAN;

extern uint8_t tx_dataa[8];
extern uint32_t rx_dataa[8];//uint8_t
...
extern uint32_t bufferr;

extern int32_t Id_ref;
extern int32_t Iq_ref;
extern int32_t Id_fbk;
extern int32_t Iq_fbk;
	
extern int32_t Torque_ref;
//extern volatile int32_t Torque_ref_t;
extern int32_t Pos_angle;
extern int32_t Speed_rpm;
	
extern int32_t Iu_adc;
extern int32_t Iv_adc;
extern int32_t Iw_adc;
extern int32_t Dcbus_v;

extern int32_t Id_err;
extern int32_t Iq_err;
extern int32_t Ud_ref;
extern int32_t Uq_ref;
extern int32_t Kp_1;
extern int32_t Ki_1;
...
void can_init(void);
void can_transmit(uint8_t dataLen, uint32_t id, uint8_t * data);
