...
/**
 * @file sim_h_struct.h
 * @brief Use for Hall SIM structure
 */
...
#ifndef SIM_H_STRUCT_H
#define SIM_H_STRUCT_H

#include "maths.h"


/**
 * @brief This structure used for Hall SIM
 */
typedef struct
{
    ...
    uint32_t flag_hall_timer_int: 1;
    uint32_t flag_hall_transition: 1;
    uint32_t temp: 26;                          // Unused bits out of 32 bits
    uint32_t flag_hall_state_int;
