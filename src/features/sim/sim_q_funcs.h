...
#ifndef SIM_Q_FUNCS_H
#define SIM_Q_FUNCS_H

#include "pac5xxx_driver_adc.h"
#include "motor_struct.h"
#include "sim_q_defs.h"
...
extern void sim_q_detect_motion(Struct_Motor *motor_ptr);
extern void sim_q_ramp_duty(Struct_Motor *motor_ptr);
...
static inline void sim_reset(Struct_Motor* motor_ptr)
{
    ...
    motor_ptr->sim.mdetect_qep_counter_start = motor_ptr->mpos.qep.counter_counts;
    motor_ptr->sim.mdetect_qepindex_counter_start = motor_ptr->mpos.qep.index_counter;
...
{
    // Detect motion
    sim_q_detect_motion(motor_ptr);
}


static inline void sim_mdetect_true(Struct_Motor *motor_ptr)
{
    motor_ptr->sim.filter_alpha_speed_store_q16 = motor_ptr->mpos.qep.filter_alpha_speed_q16;
    motor_ptr->sim.kspd_store_radps_q6 = motor_ptr->mpos.qep.kspd_radps_q6;
    motor_ptr->sim.kspd_scaled_store_q14 = motor_ptr->mpos.qep.kspd_scaled_q14;

    motor_ptr->mpos.qep.filter_alpha_speed_q16 = motor_ptr->sim.filter_alpha_speed_q16;
    motor_ptr->mpos.qep.kspd_radps_q6 = motor_ptr->sim.kspd_radps_q6;
    motor_ptr->mpos.qep.kspd_scaled_q14 = motor_ptr->sim.kspd_scaled_q14;
}
...
static inline void sim_detect2(Struct_Motor *motor_ptr)
{
    ...
    motor_ptr->sim.sim_spd_scaled_q14 = motor_ptr->mpos.mpos_spd_scaled_q14;
    motor_ptr->sim.sim_spd_radps = motor_ptr->mpos.mpos_spd_radps;
    motor_ptr->sim.sim_motor_direction = motor_ptr->mpos.mpos_motor_direction;
...
//    debug_dac_1b = motor_ptr->sim.ve_mag_scaled_q14;
...
static inline void sim_sim2cl_transition_main(Struct_Motor *motor_ptr)
{
    ...
    else if (motor_ptr->mpos.mposmode == STATE_MPOSMODE_QEP)
    {
        qep_sim2qep_main(motor_ptr);
    }
