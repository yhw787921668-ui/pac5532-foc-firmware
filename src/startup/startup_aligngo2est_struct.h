...
/**
 * @file startup_alingo2est_struct.h
...
/**
 * @brief eStateStartupAlignGo enum
 */
typedef enum
{
    ...
    STATE_STARTUP_ALIGNGO_ALIGNGO2EST,              // 3: Align&Go Startup Controller - Switch from OL to Estimator
    STATE_STARTUP_ALIGNGO_COMPLETE                  // 4: Align&Go Startup Controller - Complete State
}eStateStartupAlignGo;
...
{
    // State & Status
    eStateStartupAlignGo state;                     // Align&Go Startup Controller state
