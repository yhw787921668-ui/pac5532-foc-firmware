...
void cafe_init(void)
{
    ...
    // CFGPWR0: set vp as the configured voltage
    config_register_bits(ADDR_CFGPWR0, VP_CONFIG_BITS_MASK, CONFIG_VP_VOLTAGE);
...
{
    // This function is empty for 5523A 
}
...
#endif // #ifdef DEVICE_SELECT == DEVICE_5523A
