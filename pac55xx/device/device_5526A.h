...
#ifndef DEVICE_5526A_H
#define DEVICE_5526A_H
...
//=====================================
#define DRV_HIGHSIDE_PR         BIT_01
#define DRV_LOWSIDE_PR          BIT_00

//=====================================
// Vp voltage selection 
//=====================================
#define VP_VOLTAGE_10V       (0x00 << 2)
#define VP_VOLTAGE_12V       (0x01 << 2)
#define VP_CONFIG_BITS_MASK         0xFB
...
//=====================================
// Intermal VMS voltage divide ratio
//=====================================
#define VMS_INTERNAL_DIVIDE_RATIO               20.0f

#endif  //#ifndef DEVICE_5526A_H
