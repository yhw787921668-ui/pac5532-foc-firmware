...
void cafe_init(void)
{
   // Configure SOC Bridge for talking to CAFE
    ...
    // Diff Amp AIO54 Prop Delay 0ns (0x00), Disable HS drivers on H-PROT (0x02), Disable LS drivers on L-PROT (0x01)
    pac5xxx_tile_register_write(ADDR_CFGDRV1, (DRV_LOWSIDE_PR) | (DRV_LOWSIDE_PR));
...
{
    // This function is empty for 5556A 
}
...
#endif // #ifdef DEVICE_SELECT == DEVICE_5556A 
