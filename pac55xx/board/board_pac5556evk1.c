...
#if (BOARD_SELECT == BOARD_PAC5556EVK1)
...
void config_seq_foc(void)
{
    ...
    pac5xxx_dtse_seq_config(6, ADC0, EMUX_AB11, ADC_IRQ0_EN, 0);                     // Convert M1-Iw, then change CAFE MUX to M1-Iu, generate ADC interrupt

    pac5xxx_dtse_seq_config(7, ADC0, EMUX_AB11,                  0,           0);    // Dummy Conversion, then change CAFE MUX to VMS AB11
    pac5xxx_dtse_seq_config(8, ADC0, EMUX_AB11,                  0,           0);    // Convert VMS, then change CAFE MUX to VMS AB11

    pac5xxx_dtse_seq_config(9, ADC6, EMUX_AIO10,                 0,           0);    // Dummy conversion, then change CAFE MUX to M1-Iu
    pac5xxx_dtse_seq_config(10, ADC6, EMUX_AIO10,                0,     SEQ_END);    // Convert VM BUS, then change CAFE MUX to M1-Iu
...
void config_seq_sim(void)
{
    ...
    pac5xxx_dtse_seq_config(7, ADC0, EMUX_AB11, 0, 0);       // Convert M1-Vw, then change CAFE MUX to M1-Vu, generate ADC interrupt
    pac5xxx_dtse_seq_config(8, ADC0, EMUX_AB11, 0, 0);       // Convert M1-Vw, then change CAFE MUX to M1-Vu, generate ADC interrupt
    pac5xxx_dtse_seq_config(9, ADC0, EMUX_AB7, 0,     SEQ_END);       // Dummy conversion, then change CAFE MUX to M1-Vu
}
...
void config_seq_sim(void)
{
    ...
    pac5xxx_dtse_seq_config(7, ADC0, EMUX_AB11, 0, 0);
    pac5xxx_dtse_seq_config(8, ADC0, EMUX_AB11, 0, 0);
    pac5xxx_dtse_seq_config(9, ADC0, EMUX_AIO10, 0,     SEQ_END);
}
#endif
...
#endif // #if (BOARD_SELECT == BOARD_PAC5556EVK1)
