...
#ifndef BOARD_PAC5524RDPSENG_H
#define BOARD_PAC5524RDPSENG_H
...
// Board Configuration
//=====================================
#define DEVICE_SELECT                   DEVICE_5524
...
//=====================================
#define PCB_RSENSE_OC_OHMS              0.0025f
#define PCB_RSENSE_IUVW_OHMS            0.0025f
...
#define INVERTER_MOS_RDSON_OHMS_FLT     0.0012f
...
#define HALL_PUEN                       PCPUEN
#define HALL_MUXSEL                     PCMUXSEL
...
//=====================================
#define PPM_PORT                        PORT_PC7

//=====================================
// PWM DAC Port Definitions
//=====================================
#define PWMDAC1_PORT                    PORT_PF2
#define PWMDAC2_PORT                    PORT_PF3
#define PWMDAC3_PORT                    PORT_PC4
...
static inline void dac_psel_pwm(void)
{
    ...
    PAC55XX_SCC->PFMUXSEL.P2 = 1;
#endif

#if defined (PWMDAC2_PORT)
    PAC55XX_SCC->PFMUXSEL.P3 = 1;
#endif

#if defined (PWMDAC3_PORT)
    PAC55XX_SCC->PFMUXSEL.P4 = 1;
#endif
}
...
{
#if defined (PWMDAC1_PORT)
    PAC55XX_GPIOF->MODE.P2 = 1;
#endif

#if defined (PWMDAC2_PORT)
    PAC55XX_GPIOF->MODE.P3 = 1;
#endif

#if defined (PWMDAC3_PORT)
    PAC55XX_GPIOF->MODE.P4 = 1;
#endif
}
...
PAC5XXX_RAMFUNC static inline void pwmdac_1_set_duty(uint16_t duty)             { PAC55XX_TIMERC->CCTR2.CTR = duty; }
PAC5XXX_RAMFUNC static inline void pwmdac_2_set_duty(uint16_t duty)             { PAC55XX_TIMERC->CCTR3.CTR = duty; }
PAC5XXX_RAMFUNC static inline void pwmdac_3_set_duty(uint16_t duty)             { PAC55XX_TIMERC->CCTR4.CTR = duty; }
...
#endif  //#ifndef BOARD_PAC5524RDPSENG_H
