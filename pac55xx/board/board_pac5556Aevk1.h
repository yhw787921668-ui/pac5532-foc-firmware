...
#ifndef BOARD_PAC5556AEVK1_H
#define BOARD_PAC5556AEVK1_H
...
// Board Configuration
//=====================================
#define DEVICE_SELECT                   DEVICE_5556A
...
//=====================================
#define PCB_RSENSE_OC_OHMS              0.050f
#define PCB_RSENSE_IUVW_OHMS            0.050f

//=====================================
// Voltage Sensing Resistor Values
//=====================================
#define R1_PLUS_R2_BY_R2_RATIO_VBUS     204.0f      // Resistor ratio for VDC bus voltage sensing
#define R1_PLUS_R2_BY_R2_RATIO_SIM      168.0f      // Resistor ratio for phase voltage sensing
...
#define SIM_BEMF_DET_THRESHOLD_ADCCNT_I               40                      // Threshold for minimum phase current in ADC counts
...
#define INVERTER_IGBT_VCE_VOLTS_FLT     1.70f
#define INVERTER_IGBT_VDIODE_VOLTS_FLT  1.77f
...
//=====================================
// ADC Offset Selection For VMS
//=====================================
#define CONFIG_ADC_OFFSET_GAIN          VMS_INPUT       // VMS channel will use ADC offset and gain compensation
...
//=====================================
#define PAC5XXX_GPIO_HALLA              PAC55XX_GPIOE
#define HALLA_PORTNUM                   P4

#define PAC5XXX_GPIO_HALLB              PAC55XX_GPIOE
#define HALLB_PORTNUM                   P5

#define PAC5XXX_GPIO_HALLC              PAC55XX_GPIOE
...
#define Hall_Gpio_IRQn                  GpioE_IRQn

#define HALL_PUEN                       PEPUEN
#define HALL_MUXSEL                     PEMUXSEL

//=====================================
// QEP Input Port Definitions
//=====================================
#define PAC5XXX_GPIO_QEPPHA             PAC55XX_GPIOE
#define QEPPHB_PORTNUM                  P6

#define PAC5XXX_GPIO_QEPPHB             PAC55XX_GPIOE
#define QEPPHA_PORTNUM                  P5

#define PAC5XXX_GPIO_QEPIDX             PAC55XX_GPIOE
...
//=====================================
#define PWMDAC1_PORT                    PORT_PE4
#define PWMDAC2_PORT                    PORT_PE5
#define PWMDAC3_PORT                    PORT_PE6
...
static inline void dac_psel_pwm(void)
{
    ...
    PAC55XX_SCC->PEMUXSEL.P4 = 1;        // TCPWM4
#endif

#if defined (PWMDAC2_PORT)
    PAC55XX_SCC->PEMUXSEL.P5 = 1;        // TCPWM5
#endif

#if defined (PWMDAC3_PORT)
    PAC55XX_SCC->PEMUXSEL.P6 = 1;        // TCPWM6
#endif
}
...
{
#if defined (PWMDAC1_PORT)
    PAC55XX_SCC->PEMUXSEL.P4 = 0;
#endif

#if defined (PWMDAC2_PORT)
    PAC55XX_SCC->PEMUXSEL.P5 = 0;
#endif

#if defined (PWMDAC3_PORT)
    PAC55XX_SCC->PEMUXSEL.P6 = 0;
#endif
}
...
{
#if defined (PWMDAC1_PORT)
    PAC55XX_GPIOE->OUT.P4 = 0;
#endif

#if defined (PWMDAC2_PORT)
    PAC55XX_GPIOE->OUT.P5 = 0;
#endif

#if defined (PWMDAC3_PORT)
    PAC55XX_GPIOE->OUT.P6 = 0;
#endif
}
...
{
#if defined (PWMDAC1_PORT)
    PAC55XX_GPIOE->MODE.P4 = 1;
#endif

#if defined (PWMDAC2_PORT)
    PAC55XX_GPIOE->MODE.P5 = 1;
#endif

#if defined (PWMDAC3_PORT)
    PAC55XX_GPIOE->MODE.P6 = 1;
#endif
}
...
static inline void dac_outen_enable(void)
{
    dac_modesel_pp();
#if defined (PWMDAC1_PORT)
    PAC55XX_GPIOE->OUTMASK.P4 = 0;
#endif

#if defined (PWMDAC2_PORT)
    PAC55XX_GPIOE->OUTMASK.P5 = 0;
#endif

#if defined (PWMDAC3_PORT)
    PAC55XX_GPIOE->OUTMASK.P6 = 0;
#endif
}

PAC5XXX_RAMFUNC static inline void pwmdac_1_set_duty(uint16_t duty)             { PAC55XX_TIMERC->CCTR4.CTR = duty; }
PAC5XXX_RAMFUNC static inline void pwmdac_2_set_duty(uint16_t duty)             { PAC55XX_TIMERC->CCTR5.CTR = duty; }
PAC5XXX_RAMFUNC static inline void pwmdac_3_set_duty(uint16_t duty)             { PAC55XX_TIMERC->CCTR6.CTR = duty; }
...
static inline int16_t readseq_aio10_raw(void)               { return PAC55XX_ADC->DTSERES2.VAL; }
static inline int16_t readseq_aio32_raw(void)               { return PAC55XX_ADC->DTSERES4.VAL; }
static inline int16_t readseq_aio54_raw(void)               { return PAC55XX_ADC->DTSERES6.VAL; }

PAC5XXX_RAMFUNC static inline int16_t readseq_iphase_u_raw(void)            { return PAC55XX_ADC->DTSERES2.VAL; }
PAC5XXX_RAMFUNC static inline int16_t readseq_iphase_v_raw(void)            { return PAC55XX_ADC->DTSERES4.VAL; }
PAC5XXX_RAMFUNC static inline int16_t readseq_iphase_w_raw(void)            { return PAC55XX_ADC->DTSERES6.VAL; }
...
static inline int16_t readseq_vbus_raw(void)                { return PAC55XX_ADC->DTSERES0.VAL; }
#if (INTERNAL_VMS == TRUE)
static inline int16_t readseq_vbus_vms_raw(void)            { return PAC55XX_ADC->DTSERES8.VAL; }
#endif
...
#endif  //#ifndef BOARD_PAC5556AEVK1_H
