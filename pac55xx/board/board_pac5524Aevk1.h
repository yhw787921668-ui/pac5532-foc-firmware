...
#ifndef BOARD_PAC5524AEVK1_H
#define BOARD_PAC5524AEVK1_H
...
// Board Configuration
//=====================================
#define DEVICE_SELECT                   DEVICE_5524A
...
//==========================================================================
#if 0
#define PPM_IO_MUXSEL                   PFMUXSEL
#define PAC5XXX_GPIO_PPM_IN             PAC55XX_GPIOF
#define PPM_INPUT_PORTNUM               P2
#define PPM_INPUT_PORT_BIT              BIT_02
#define PPM_PORT                        PORT_PF2
#define PPM_Timer TimerC
#define PPM_Timer_Ptr                   PAC55XX_TIMERC
#define PPM_Timer_IntFlag               INT
#define PPM_Timer_IRQn                  TimerC_IRQn
#define PPM_CC_CONTROL                  CCTL2
#define PPM_CC_COUNTER                  CCTR2
#define PPM_CCR_INT_FLAG                CCR2IF
#endif

#define PPM_IO_MUXSEL                   PCMUXSEL
#define PAC5XXX_GPIO_PPM_IN             PAC55XX_GPIOC
#define PPM_INPUT_PORTNUM               P3
#define PPM_INPUT_PORT_BIT              BIT_03
#define PPM_PORT                        PORT_PC3
#define PPM_Timer TimerC
#define PPM_Timer_Ptr                   PAC55XX_TIMERC
#define PPM_Timer_IntFlag               INT
#define PPM_Timer_IRQn                  TimerC_IRQn
#define PPM_CC_CONTROL                  CCTL3
#define PPM_CC_COUNTER                  CCTR3
#define PPM_CCR_INT_FLAG                CCR3IF

//=====================================
// PPM Port, Timer, Int Definitions
//=====================================
...
#endif  //#ifndef BOARD_PAC5524AEVK1_H
