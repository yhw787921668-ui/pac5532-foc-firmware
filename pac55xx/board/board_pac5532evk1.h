...
#ifndef BOARD_PAC5532EVK1_H
#define BOARD_PAC5532EVK1_H
...
//=====================================
#define R1_PLUS_R2_BY_R2_RATIO_VBUS     29.00f      // Resistor ratio for VDC bus voltage sensing
#define R1_PLUS_R2_BY_R2_RATIO_SIM      29.00f      // Resistor ratio for phase voltage sensing
...
#define INVERTER_MOS_RDSON_OHMS_FLT     0.0197f
...
PAC5XXX_RAMFUNC static inline int16_t readseq_test(void)                { return PAC55XX_ADC->DTSERES10.VAL >> 2; }
...
#endif  //#ifndef BOARD_PAC5532EVK1_H
