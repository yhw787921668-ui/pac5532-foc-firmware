...
#if (BOARD_SELECT == BOARD_PAC5556AEVK1)
...
void config_seq_sim(void)
{
    ...
    pac5xxx_dtse_seq_config(7, ADC0, EMUX_AB11,                  0,           0);    // Dummy Conversion, then change CAFE MUX to VMS AB11
    pac5xxx_dtse_seq_config(8, ADC0, EMUX_AB11,                  0,           0);    // Convert VMS, then change CAFE MUX to VMS AB11
    pac5xxx_dtse_seq_config(9, ADC6, EMUX_AB7, 0,     SEQ_END);       // Dummy conversion, then change CAFE MUX to M1-Vu
}
...
void config_seq_sim(void)
{
    ...
    pac5xxx_dtse_seq_config(7, ADC0, EMUX_AB11,                  0,           0);    // Dummy Conversion, then change CAFE MUX to VMS AB11
    pac5xxx_dtse_seq_config(8, ADC0, EMUX_AB11,                  0,           0);    // Dummy Conversion, then change CAFE MUX to VMS AB11
    pac5xxx_dtse_seq_config(9, ADC0, EMUX_AB11,                  0,           0);    // Convert VMS, then change CAFE MUX to VMS AB11
    pac5xxx_dtse_seq_config(10, ADC6, EMUX_AIO10,                 0,     SEQ_END);    // Dummy conversion, then change CAFE MUX to M1-Iu
}
#endif
...
#endif // #if (BOARD_SELECT == BOARD_PAC5556AEVK1)
