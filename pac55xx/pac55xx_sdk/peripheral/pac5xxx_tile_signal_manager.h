...
#if defined(PAC5526) || defined(PAC5527)   
...
#if !( defined(PAC5526) || defined(PAC5527) )   // PAC5526 and PAC5527 don't have CFGIO2; Only define if neither of those devices is defined
...
#if defined(PAC5526) || defined (PAC5527)       // Only PAC5526 and PAC5527 have ADDR_GPO
