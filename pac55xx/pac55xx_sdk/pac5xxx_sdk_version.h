...
#define SDK_VERSION_RELEASE_STATE   PAC5XXX_BETA  //PAC5XXX_RELEASED, PAC5XXX_RC, PAC5XXX_BETA, PAC5XXX_ALPHA, PAC5XXX_IN_DEVELOPMENT 
#define SDK_VERSION_RELEASE_NUM     1
#define SDK_VERSION_STR             "v1.7.0-beta1"

#endif /* PAC5XXX_SDK_VERSION_H */

/*============= Change Log  ===============================================================
===========================
PAC55XX SDK v1.7.0-beta1
===========================
- Added PAC5556A
...
PAC55XX SDK v1.6.1
===========================
- in pac5xxx_tile_signal_manager.h, fixed an issue with new PAC5526 define for ADDR_CFGIO2

===========================
PAC55XX SDK v1.6.0
===========================
- Added PAC5526 Support
- Changed pac_recovery() delay to 6 seconds
