...
void cafe_init(void)
{
    ...
    pac5xxx_tile_register_write(ADDR_ADCSCAN, 0xFF);                // GAO7SH=1, GAO8SH=1, GAO9SH=1, ENADCBUF=1, ENSCAN=1, for auto-scan, sample and hold AO10SH=1, AO32SH=1, AO54SH=1

#if (ENABLE_VDS_CBC == TRUE)
#if(1)
    pac5xxx_tile_register_write(ADDR_CFGVDS1, VDSCFG1_DISCBC52_EN | VDSCFG1_DISCBC41_EN | VDSCFG1_DISCBC30_EN | VDSCFG1_VDEN_EN | VDSCFG1_VDSBLNK_4000nS);
    pac5xxx_tile_register_write(ADDR_CFGVDS2, VDSCFG2_VDSTLL_120mV | VDSCFG2_VDSTLH_120mV);
    pac5xxx_tile_register_write(ADDR_CFGCBC, CFGCBC_CBCEN_VDSTH_EN | CFGCBC_CBCEN_VDSTL_EN| CFGCBC_CBCTYPE_ALL_OFF);
    pac5xxx_tile_register_write(ADDR_CBCFLAG, 0xFF);
#else
    pac5xxx_tile_register_write(0x40, (1<<4) | (0x0F));
    pac5xxx_tile_register_write(0x41, (1<<4) | (1<<0));
    pac5xxx_tile_register_write(0x42, (1<<5) | (1<<4)| (0<<0));
    pac5xxx_tile_register_write(0x43, 0xFF);
#endif
    pac5xxx_tile_register_write(0x63, (0<<3) | (1<<2));
#endif
...
{
    // This function is empty for 5522 
}
...
#endif // #ifdef DEVICE_SELECT == DEVICE_52711
