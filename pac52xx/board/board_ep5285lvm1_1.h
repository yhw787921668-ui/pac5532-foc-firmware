...
/**
 *  @file board_ep5285lvm1_1.h
 *  @brief EP5285LVM1-1 Board Configuration Definitions
 */
...
#ifndef BOARD_EP5285LVM1_1_H
#define BOARD_EP5285LVM1_1_H
...
#define HIB_BIT_DEFAULT             0                                                                   //BIT7, 0 = Normal; 1 = Hibernate
#define PBEN_BIT_DEFAULT            0                                                                   //BIT6, 0 = Push Button Disabled; 1 = Push Button Enabled (AIO6)
#define RFU_BIT_DEFAULT             0                                                                   //BIT5, 0 = Defualt
#define CLKOUTEN_BIT_DEFAULT        0                                                                   //BIT4, 0 = Disabled; 1 = Enabled
#define MCUALIVE_BIT_DEFAULT        1                                                                   //BIT3, 0 = Disabled; 1 = Enabled
#define TPBD_BIT_DEFAULT            0                                                                   //BIT2, 0 = 32 msec, 1 = 1 msec
#define PB_POL_BIT_DEFAULT          0                                                                   //BIT1, 0 = Push Button Polarity, acive low
#define ENSIG_BIT_DEFAULT           1                                                                   //BIT0, 0 = Disabled; 1 = Enabled
#define MODULE_MISC_BITS_DEFAULT    ((HIB_BIT_DEFAULT << 7) + (PBEN_BIT_DEFAULT << 6) + (RFU_BIT_DEFAULT << 5) + (CLKOUTEN_BIT_DEFAULT << 4) + (MCUALIVE_BIT_DEFAULT << 3) + (TPBD_BIT_DEFAULT << 2) + (RFU_BIT_DEFAULT << 1) + (ENSIG_BIT_DEFAULT << 0))
...
// Board Configuration
//=====================================
#define DEVICE_SELECT                   DEVICE_5285
#define CAPABLE_VSIM                    TRUE
#define CAPABLE_IPD                     TRUE
#define CONFIG_SHUNT                    CONFIG_SHUNT_1SHUNT
#define CAPABLE_POWERMETHOD2            FALSE
//#define ENABLE_5285_LPDAC_INT
//#define ENABLE_OVER_TEMPERAURE_WARNING
#define ENABLE_DRIVER_FAULT

//=====================================
// DC Bus Voltage
//=====================================
#define MIN_VBUS                        VDC_6V
#define MAX_VBUS                        VDC_20V

//=====================================
// Current Sensing Resistor Values
//=====================================
#define PCB_RSENSE_OC_OHMS              0.20f
#define PCB_RSENSE_IUVW_OHMS            0.20f

//=====================================
// Voltage Sensing Resistor Values
//=====================================
#define R1_PLUS_R2_BY_R2_RATIO_VBUS     20.00f      // Resistor ratio for VDC bus voltage sensing
#define R1_PLUS_R2_BY_R2_RATIO_SIM      10.00f      // Resistor ratio for phase voltage sensing
...
// Deadtime
//=====================================
#define MOTOR1_LED_NSEC                 1           // Rising edge deadtime in nsec
#define MOTOR1_TED_NSEC                 1           // Falling edge deadtime in nsec
...
// AIO Port Mapping
//=====================================
#define SELECT_AIO_ISHUNT               CHANNEL_AIO10
...
#define CONFIG_OFFSET                   (CHANNEL_AIO10)
...
static inline int16_t readseq_iphase_u_raw(void)        { return PAC5XXX_ADC->AS0R1.VAL; }
static inline int16_t readseq_iphase_v_raw(void)        { return PAC5XXX_ADC->AS0R1.VAL; }
static inline int16_t readseq_iphase_w_raw(void)        { return PAC5XXX_ADC->AS0R1.VAL; }
...
// ADC Sequencer Readout Macro Functions
//static inline int16_t readseq_vbus_raw(void)             { return PAC5XXX_ADC->AS1R2.VAL; }
static inline int16_t readseq_temperature(void)         { return PAC5XXX_ADC->AS1R3.VAL; }
...
// ADC Sequencer Readout Macro Functions
PAC5XXX_RAMFUNC static inline int16_t readseq_ssi1_raw(void)             { return PAC5XXX_ADC->AS0R0.VAL; }
PAC5XXX_RAMFUNC static inline int16_t readseq_ssi2_raw(void)             { return PAC5XXX_ADC->AS1R0.VAL; }

void init_emux(void);

void config_seq_ipd(uint32_t sequencer_trigger_value);

#endif  //#ifndef BOARD_EP5285LVM1_1_H
