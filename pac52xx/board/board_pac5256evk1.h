...
#ifndef BOARD_PAC5256EVK1_H
#define BOARD_PAC5256EVK1_H
...
// Vbus                  : Seq1/N0
// Motor Phase Voltage U : Seq0/N1
// Motor Phase Voltage V : Seq0/N2
// Motor Phase Voltage W : Seq0/N3
...
#define PWMDAC3_PORTNUM                 P4
#define PWMDAC3_PSEL                    1
#define PWMDAC3_TIMER                   PAC5XXX_TIMERD
#define PWMDAC3_CTR                     CTR1
...
//#if (INTERNAL_VMS == TRUE)
//static inline int16_t readseq_vbus_vms_raw(void)                { return PAC5XXX_ADC->AS1R0.VAL; }
//#endif
...
#endif  //#ifndef BOARD_PAC5256EVK1_H
