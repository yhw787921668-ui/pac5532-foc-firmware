...
#ifndef BOARD_EP5223LVM1_1_1SHUNT_PWR2_H
#define BOARD_EP5223LVM1_1_1SHUNT_PWR2_H
...
// Board Configuration
//=====================================
#define DEVICE_SELECT                   DEVICE_5223
#define CAPABLE_VSIM                    TRUE
#define CAPABLE_IPD                     TRUE
#define CONFIG_SHUNT                    CONFIG_SHUNT_1SHUNT
#define CAPABLE_POWERMETHOD2            TRUE
#define CAPABLE_TEMPERATURE             FALSE
...
#define SELECT_AIO_POWER                CHANNEL_AIO6

//=====================================
// AIO6
//=====================================
#define AIO6_GAIN                       AIO6789_GAIN_X8
...
#define CONFIG_OFFSET                   (CHANNEL_AIO32 | CHANNEL_AIO6)
...
#define ADC_OFFSET_DEFAULT_AIO6         QCONST((0.1 / 2.5 * 1024), Q00)        // 0.1V / 2.5 * 1024
#define ADC_OFFSET_MIN_AIO6             QCONST((0.05 / 2.5 * 1024), Q00)          // 0.1V / 2.5 * 1024
#define ADC_OFFSET_MAX_AIO6             QCONST((0.15 / 2.5 * 1024), Q00)          // 0.1V / 2.5 * 1024

//=====================================
// NTC over temperature protect (Optional)
//=====================================
#define NTC_PROTECT_RESISTOR_VALUE      (528)
#define UP_RESISTOR_VALUE               (470)
#define DOWN_RESISTOR_VALUE             (470)
#define SUM_RESISTOR_VALUE              (UP_RESISTOR_VALUE + DOWN_RESISTOR_VALUE)*65536
#define NTC_PROTECT_ADC_VALUE           ((SUM_RESISTOR_VALUE*1023)/(NTC_PROTECT_RESISTOR_VALUE + SUM_RESISTOR_VALUE))
#define KEEP_OVER_TERMPERATURE_TIME     100                           // 100 ==> 1s
#define KEEP_UNDER_TERMPERATURE_TIME    100                           // 100 ==> 1s
...
static inline int16_t readseq_aio32_raw(void)           { return PAC5XXX_ADC->AS0R0.VAL; }

PAC5XXX_RAMFUNC static inline int16_t readseq_iphase_u_raw(void)           { return PAC5XXX_ADC->AS0R1.VAL; }
PAC5XXX_RAMFUNC static inline int16_t readseq_iphase_v_raw(void)           { return PAC5XXX_ADC->AS0R1.VAL; }
PAC5XXX_RAMFUNC static inline int16_t readseq_iphase_w_raw(void)           { return PAC5XXX_ADC->AS0R1.VAL; }
...
// ADC Sequencer Readout Macro Functions
//static inline int16_t readseq_vbus_raw(void)                            { return PAC5XXX_ADC->AS1R1.VAL; }
...
static inline int16_t readseq_ibusavg_raw()             { return PAC5XXX_ADC->AS1R2.VAL; }

void init_emux(void);

void config_seq_ipd(uint32_t sequencer_trigger_value);

#endif  //#ifndef BOARD_EP5223LVM1_1_1SHUNT_PWR2
