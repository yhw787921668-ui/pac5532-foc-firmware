...
#if (BOARD_SELECT == BOARD_PAC5232EVK1_1SHUNT)
...
void config_seq_foc(void)
{
    ...
    pac5xxx_adc_as0_sequence_config(0, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO32, ASSEQ_DELAY_0);        // Convert M1-Iu, then change CAFE MUX to M1-Iv
    ...
    pac5xxx_adc_as1_sequence_config(0, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO32, ASSEQ_DELAY_0);   // Convert I2, then change CAFE MUX to Vbus
    pac5xxx_adc_as1_sequence_config(1, ADCCTL_ADMUX_AD3, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO32, ASSEQ_DELAY_0);   // Convert Vbus, then change CAFE MUX to M1-Iu
...
void config_seq_ipd(uint32_t sequencer_trigger_value)
{
    ...
    pac5xxx_adc_as0_sequence_config(0, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO32 | SIGMGR_MSPI_SH_DIFFAMP, ASSEQ_DELAY_0);  // 
    pac5xxx_adc_as0_sequence_config(1, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO32, ASSEQ_DELAY_0);                           // Convert Vbus, then change CAFE MUX to M1-Iu

    // AS1 configuration
    pac5xxx_adc_as1_config_pwm(ADCCTLX_AS1D_DEPTH2, ADCCTLX_TRIGEDGE_HITOLOW, ADCCTLX_TRIGPWM_PWMA0);
    pac5xxx_adc_as1_sequence_config(0, ADCCTL_ADMUX_AD3, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO32, ASSEQ_DELAY_0);   // Convert Vbus, then change CAFE MUX to M1-Iu
    pac5xxx_adc_as1_sequence_config(1, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO32, ASSEQ_DELAY_0);   // then change CAFE MUX to M1-Iu
...
void config_seq_sim(void)
{
    ...
    pac5xxx_adc_as0_sequence_config(2, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AB7, ASSEQ_DELAY_0);                                   // Convert M1-Vw, then change CAFE MUX to M1-Vu

    // AS1 configuration
    pac5xxx_adc_as1_config_pwm(ADCCTLX_AS1D_DEPTH1, ADCCTLX_TRIGEDGE_LOWTOHI, ADCCTLX_TRIGPWM_PWMA0);
    pac5xxx_adc_as1_sequence_config(0, ADCCTL_ADMUX_AD3, ASSEQ_MSPI_AFTER_SH, SIGMGR_AB7, ASSEQ_DELAY_0);                                   // Convert Vout, then change CAFE MUX to M1-Vu
}
...
void init_emux(void)
{
    ...
    PAC5XXX_ADC->EMUXDATA.VAL = SIGMGR_AIO32;           // Set EMUX to AIO10
...
#endif // #if (BOARD_SELECT == BOARD_PAC5232EVK1_1SHUNT)
