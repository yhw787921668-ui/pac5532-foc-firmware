...
/** @file board_pac52400evk1.c
 *  @brief PAC52400EVK1 Board Configuration Functions
 */
...
#ifndef BOARD_PAC52400EVK_H
#define BOARD_PAC52400EVK_H
...
// AIO10 = ADC sampling, OC 
// AIO32 = ADC sampling, OC 
// AIO54 = ADC sampling, OC 
// AIO6 = Input (Not Used)
...
// Board Configuration
//=====================================
#define DEVICE_SELECT                   DEVICE_52400
...
//=====================================
// IR Receiver Pulse Decoding
// Using PD5 input
//=====================================
#define IR_Timer_Ptr            PAC5XXX_TIMERC
#define Timer_IRQ               TimerC_IRQn
#define IR_Timer                TimerC
#define PAC5XXX_GPIO_IR_PORT    PAC5XXX_GPIOD
#define IR_TIMER_COUNTER        CTR1
#define IR_TIMER_CCR_CTRL_0     CCTRL0
#define IR_TIMER_CCR_CTRL_1     CCTRL1
#define IR_PORT_BIT_SHIFT       5
#define IR_PORT_NUM             1 << IR_PORT_BIT_SHIFT
#define IR_PORT_NUM_SEL         P5

//=====================================
// Power Down Input Port Definitions
// Active Low, PullUp Internally
//=====================================
#define PAC5XXX_GPIO_PWR_DOWN_INPUT     PAC5XXX_GPIOE   // Port E
#define PWR_DOWN_PORTNUM                P4              // Port P4
#define Pwr_Down_Input_Gpio_IRQn        GpioE_IRQn
...
#endif  //#ifndef BOARD_EP5222LVM1_1_1SHUNT_H
