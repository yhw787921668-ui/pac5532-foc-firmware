...
#if (BOARD_SELECT == BOARD_PAC5256EVK1_REV_AB) || (BOARD_SELECT == BOARD_PAC5256EVK1_REV_C)
...
void config_seq_foc(void)
{
    ...
    pac5xxx_adc_as0_sequence_config(0, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO32 | SIGMGR_MSPI_SH_DIFFAMP, ASSEQ_DELAY_0);       // Convert M1-Iu, then change CAFE MUX to M1-Iv
    pac5xxx_adc_as0_sequence_config(1, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO54 | SIGMGR_MSPI_SH_DIFFAMP, ASSEQ_DELAY_0);       // Convert M1-Iv, then change CAFE MUX to M1-Iw
    pac5xxx_adc_as0_sequence_config(2, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AB11, ASSEQ_DELAY_0);                                 // Convert M1-Iw, then change CAFE MUX to Vout=AB11
    // AS1 configuration
    pac5xxx_adc_as1_config_pwm(ADCCTLX_AS1D_DEPTH2, ADCCTLX_TRIGEDGE_LOWTOHI, ADCCTLX_TRIGPWM_PWMA0);
    pac5xxx_adc_as1_sequence_config(0, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AB11, ASSEQ_DELAY_0);                            // Convert Vout, then change CAFE MUX to M1-Iu
    pac5xxx_adc_as1_sequence_config(1, ADCCTL_ADMUX_AD2, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO10, ASSEQ_DELAY_0);
...
void config_seq_ipd(uint32_t sequencer_trigger_value)
{
    ...
    pac5xxx_adc_as0_sequence_config(0, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO32 | SIGMGR_MSPI_SH_DIFFAMP, ASSEQ_DELAY_0);        // Convert M1-Iu, then change CAFE MUX to M1-Iv
    pac5xxx_adc_as0_sequence_config(1, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO54 | SIGMGR_MSPI_SH_DIFFAMP, ASSEQ_DELAY_0);        // Convert M1-Iv, then change CAFE MUX to M1-Iw
    pac5xxx_adc_as0_sequence_config(2, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AB11, ASSEQ_DELAY_0);                                 // Convert M1-Iw, then change CAFE MUX to M1-Iu

    // AS1 configuration
    pac5xxx_adc_as1_config_pwm(ADCCTLX_AS1D_DEPTH3, ADCCTLX_TRIGEDGE_HITOLOW, ADCCTLX_TRIGPWM_PWMA0);
    pac5xxx_adc_as1_sequence_config(0, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AB11, ASSEQ_DELAY_0);                            // Convert Vout, then change CAFE MUX to M1-Iu
    pac5xxx_adc_as1_sequence_config(1, ADCCTL_ADMUX_AD2, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO10, ASSEQ_DELAY_0);
    pac5xxx_adc_as1_sequence_config(2, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO10, ASSEQ_DELAY_0);
}
...
void config_seq_sim(void)
{
    ...
    pac5xxx_adc_as1_sequence_config(1, ADCCTL_ADMUX_AD2, ASSEQ_MSPI_AFTER_SH, SIGMGR_AB7, ASSEQ_DELAY_0);                                   // Convert Vout, then change CAFE MUX to M1-Vu
...
void config_seq_sim(void)
{
    ...
    // AS1 configuration
    pac5xxx_adc_as1_config_pwm(ADCCTLX_AS1D_DEPTH2, ADCCTLX_TRIGEDGE_LOWTOHI, ADCCTLX_TRIGPWM_PWMA0);
    pac5xxx_adc_as1_sequence_config(0, ADCCTL_ADMUX_AD0, ASSEQ_MSPI_AFTER_SH, SIGMGR_AB11, ASSEQ_DELAY_0);                                 // Convert Vout VMS, then change CAFE MUX to M1-Iu
    pac5xxx_adc_as1_sequence_config(1, ADCCTL_ADMUX_AD2, ASSEQ_MSPI_AFTER_SH, SIGMGR_AIO10, ASSEQ_DELAY_0);                                // Convert Vout VBUS, then change CAFE MUX to M1-Iu
}
#endif
