...
//=====================================
#define DEVICE_52XX             (0x52 << 8)
#define DEVICE_52XXX            (0x02 << 8)
#define DEVICE_VERSION_NONE     (0x00 << 16)
#define DEVICE_VERSION_A        (0x0A << 16)
#define DEVICE_2710_ASCII       (0x30313732)    // ASCII Table: 0x30->0; 0x31->1; 0x37->7; 0x32->2
#define DEVICE_2711_ASCII       (0x31313732)    // ASCII Table: 0x31->1; 0x31->1; 0x37->7; 0x32->2
#define DEVICE_2400_ASCII       (0x30303432)    // ASCII Table: 0x30->0; 0x30->0; 0x34->4; 0x32->2
#define DEVICE_5220             DEVICE_VERSION_NONE + DEVICE_52XX + (0x20)
#define DEVICE_5223             DEVICE_VERSION_NONE + DEVICE_52XX + (0x23)
#define DEVICE_5250             DEVICE_VERSION_NONE + DEVICE_52XX + (0x50)
#define DEVICE_5253             DEVICE_VERSION_NONE + DEVICE_52XX + (0x53)
#define DEVICE_5232             DEVICE_VERSION_NONE + DEVICE_52XX + (0x32)
#define DEVICE_5222             DEVICE_VERSION_NONE + DEVICE_52XX + (0x22)
#define DEVICE_5256             DEVICE_VERSION_NONE + DEVICE_52XX + (0x56)
#define DEVICE_5285             DEVICE_VERSION_NONE + DEVICE_52XX + (0x85)
#define DEVICE_52710            DEVICE_2710_ASCII
#define DEVICE_52711            DEVICE_2711_ASCII
#define DEVICE_52400            DEVICE_2400_ASCII

//=====================================
// Shunt Configurations (CONFIG_SHUNT)
//=====================================
#define CONFIG_SHUNT_1SHUNT     1
#define CONFIG_SHUNT_2SHUNT     2
