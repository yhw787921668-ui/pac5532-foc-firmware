...
#define SIGMGR_MSPI(channel)            (channel)                        /*!< EMUX data for given channel */
#define SIGMGR_MSPI_SH_DIFFAMP          (SIGMGR_SH_DIFFAMP10_HOLD | SIGMGR_SH_DIFFAMP32_HOLD | SIGMGR_SH_DIFFAMP54_HOLD)             /*!< EMUX data for S&H start on DiffAmp channels */
#define SIGMGR_MSPI_SH_COMP             (SIGMGR_EN_SH_COMP)                /*!< EMUX data for comparator */
...
#define SIGMGR_MSPI(channel)            (channel)                          /*!< EMUX data for given channel */
#define SIGMGR_MSPI_SH_DIFFAMP          (SIGMGR_SH_DIFFAMP10_HOLD)         /*!< EMUX data for S&H start on DiffAmp channels */
#define SIGMGR_MSPI_SH_COMP             (SIGMGR_EN_SH_COMP)                /*!< EMUX data for comparator */
...
typedef enum {
    ADDR_CFGAIO10 = 0x07,                   /*!< Signal Manager AIO10 Configuration Register                */
    ADDR_CFGAIO6 = 0x0C,                    /*!< Signal Manager AIO10 Configuration Register                */
    ADDR_LPDACH = 0x12,                     /*!< Signal Manager LP DAC Threshold High-bits Register         */
    ADDR_EMUXEN = 0x15,                     /*!< Signal Manager Sample and Hold Configuration 1 Register    */
    ADDR_EMUXEN_READ = 0x16,                /*!< Signal Manager Sample and Hold Configuration 1 Register    */
    ADDR_PROTINTM = 0x17,                   /*!< Signal Manager Driver Protection Interrupt Mask Register   */
    ADDR_PROTSTAT = 0x18,                   /*!< Signal Manager Driver Protection Interrupt Status Register */
    ADDR_CUS0 = 0x1E,                       /*!< Signal Manager Register Reserve for the customer write the "note" that only clear by the power lost at VM */
} Signal_Manager_Reg_Addr;
#endif  // CAFE_ARCH3
...
#if defined PAC5222 || defined(PAC52710)  || defined PAC52711
    ADDR_SPECCFG0 = 0x39,                   /*!< Signal Manager AIO8-9 Hysteresis Configuration Register    */
    ADDR_SPECCFG1 = 0x3A,                   /*!< Signal Manager AIO7-8 Comparator MUX Configuration Register*/
#endif
...
#if defined(PAC5222)
        __IO uint8_t BLANKMODE              : 2;        /*!< BEMF Comparator Blanking Mode                  */
        __IO uint8_t HYSMODE                : 1;        /*!< Hysteresis Mode                                */
#else
...
typedef union
{
    ...
    struct
    {
        __IO uint8_t SMEN                   : 1;        /*!< SigMgr tile enable: 1; Disable: 0              */
             uint8_t                        : 7;
    };
} ENSIG;

#if defined(PAC5222)
/*!< SPECCFG1: Address: 0x39    AIO9 and AIO8 Hysteresis Configuration */
typedef union
{
    __IO uint8_t b;
    struct
    {
        __IO uint8_t HYSAIO9                    : 4;    /*!< AIO9 Special Mode Comparator Rising/Falling Hysteresis  */
             uint8_t HYSAIO8                    : 4;    /*!< AIO8 Special Mode Comparator Rising/Falling Hysteresis  */
    };
} SPECCFG1;

/*!< SPECCFG2: Address: 0x3A    AIO7 Hysteresis and Blanking Time Configuration */
typedef union
{
    __IO uint8_t b;
    struct
    {
        __IO uint8_t BLANKINGTIME               : 4;    /*!< Blanking time for special mode comparators (AIO[9:7])   */
             uint8_t HYSAIO7                    : 4;    /*!< AIO7 Special Mode Comparator Rising/Falling Hysteresis  */
    };
} SPECCFG2;
#endif
