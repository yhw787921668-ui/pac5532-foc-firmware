...
typedef enum {
    ADDR_FAULT = 0x00,                      /*!< Power Manager Fault Condition Indication Register          */
    ADDR_STATUS = 0x01,                     /*!< Power Manager Hardware Status Register                     */
    ADDR_MISC = 0x02,                       /*!< Power Manager Miscellaneous Features Register              */
    ADDR_PWRCTL = 0x03,                     /*!< Power Manager Control Register                             */
    ADDR_FAULTEN = 0x04,                    /*!< Power Manager Fault Enable Register                        */
    ADDR_WATCHDOG = 0x05,                   /*!< Power Manager Watchdog Configuration Register              */
    ADDR_SYSCONF = 0x19                     /*!< Power Manager System Configuration Register                */
} Power_Manager_Reg_Addr;
#endif  // CAFE_ARCH3
...
typedef enum {
    ...
    ADDR_RSTSTAT = 0x01,                    /*!< Reset Status Register                                      */
#endif
...
typedef enum {
    ...
    // FMODE = 1
    FREQ_181_kHZ = 0,                       /*!< Switching Frequency Setting: 181kHz (FMODE = 0)            */
    FREQ_200_kHZ = 1,                       /*!< Switching Frequency Setting: 200kHz (FMODE = 0)            */
    FREQ_220_kHZ = 2,                       /*!< Switching Frequency Setting: 220kHz (FMODE = 0)            */
    FREQ_250_kHZ = 3,                       /*!< Switching Frequency Setting: 250kHz (FMODE = 0)            */
    FREQ_289_kHZ = 4,                       /*!< Switching Frequency Setting: 289kHz (FMODE = 0)            */
    FREQ_330_kHZ = 5,                       /*!< Switching Frequency Setting: 330kHz (FMODE = 0)            */
    FREQ_400_kHZ = 6,                       /*!< Switching Frequency Setting: 400kHz (FMODE = 0)            */
    FREQ_500_kHZ = 7                        /*!< Switching Frequency Setting: 500kHz (FMODE = 0)            */
} PAC5XXX_FSWM_Type;
...
#if defined(PAC52710)  || defined PAC52711
/*!< RSTSTAT: Address: 0x01      Reset Status Register */
typedef union
{
    __IO uint8_t b;
    struct {
        __IO uint8_t HIBRST                 : 1;        /*!< Hibernate wakeup caused reset                          */
        __IO uint8_t SOFTRST                : 1;        /*!< Soft reset caused reset                                */
        __I  uint8_t FLTRST                 : 1;        /*!< Power fault/Temp fault caused reset                    */
        __I  uint8_t WDTRST                 : 1;        /*!< Watchdog Timer caused reset                            */
        __I  uint8_t PBRST                  : 1;        /*!< Push button caused reset                               */
        __I  uint8_t PWRINT                 : 1;        /*!< Initial Startup Indicator                              */
             uint8_t                        : 2;
    };
} RSTSTAT;
#endif
