...
/**
 * @brief  This function enable - disable ASC0 unit
 *
 * @param sequencer enable
 * @return none
 */
RAMFUNC_ADC static void pac5xxx_adc_as0_enable(int enable) { PAC5XXX_ADC->ASCTL0.AS0SEQEN = enable; }

/**
 * @brief  This function enable - disable ASC1 unit
 *
 * @param sequencer enable
 * @return none
 */
RAMFUNC_ADC static void pac5xxx_adc_as1_enable(int enable) { PAC5XXX_ADC->ASCTL1.AS1SEQEN = enable; }
